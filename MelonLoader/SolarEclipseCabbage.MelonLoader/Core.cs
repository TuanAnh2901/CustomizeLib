...
[assembly: MelonInfo(typeof(SolarEclipseCabbage.MelonLoader.Core), "SolarEclipseCabbage", "1.0.0", "Salmon", null)]
[assembly: MelonGame("LanPiaoPiao", "PlantsVsZombiesRH")]

namespace SolarEclipseCabbage.MelonLoader
{
    public class Core : MelonMod
    {
        ...
        /*public override void OnUpdate()
        {
            ...
            {
                CreatePlant.Instance.SetPlant(0, 0, PlantType.UltimateRedLunar);
                CreatePlant.Instance.SetPlant(0, 1, SolarEclipseCabbage.PlantID);
                TravelMgr.Instance.advancedUpgrades[SolarEclipseCabbage.BuffID] = true;
                MelonLogger.Msg(GameAPP.gameAPP.name);
            }
        }*/
    }
